...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6ca7bb8a1d98899fded92db8da44bc29) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Library
                 ({
                     cs_name = "deriving-yojson-syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Pa_deriving_yojson"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "deriving-yojson";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "deriving-yojson";
                           InternalLibrary "deriving-yojson-syntax"
                        ];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\026\003\220\127k\163\244\225N\190\030\205\226\157\224_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
